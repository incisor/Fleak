...
////////////////////////////////////////////////////////////////////////////////
-(CGPoint) inverseConvertedPoint:(CGPoint)pt //internal use only
{
        ...
        if(nil != body)
        {
            ...
            if(b2_dynamicBody != body->GetType()) //we dont update dynamic bodies
            {
                if(curSpr != nil)
                {
                    ...
                    CGPoint pos = [self inverseConvertedPoint:[curSpr position]];
                      ...
                      startPoint:(int)startPoint
{
    ...
    [self moveSprite:spr onPathWithUniqueName:uniqueName speed:pathSpeed startPoint:startPoint];
}
						  ...
						  world:(b2World*)_world
{
    ...
    if(!convertPhysic)
    {
        CGPoint LHPos = LHPointFromString([spriteProp objectForKey:@"Position"]);
        LHPos.y = safeFrame.y - LHPos.y;
        position = b2Vec2(LHPos.x/PTM_RATIO, LHPos.y/PTM_RATIO);
    }
